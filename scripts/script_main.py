...
def main():
    ...
    try:
        WebDriverWait(web_browser, 10).until(EC.presence_of_element_located((By.XPATH, xpath_miui.dialogOkBtn)))
        web_browser.find_element(By.XPATH, xpath_miui.dialogOkBtn).click()
        log("LOGIN", "Post-login dialog handled")
    except TimeoutException:
        log("LOGIN", "No post-login dialog present, continuing")
