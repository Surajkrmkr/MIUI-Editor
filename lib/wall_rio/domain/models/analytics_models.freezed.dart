...
mixin _$AdMobMetrics {
  ...
  $AdMobMetricsCopyWith<AdMobMetrics> get copyWith =>
      _$AdMobMetricsCopyWithImpl<AdMobMetrics>(
          this as AdMobMetrics, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, earnings, impressions, ecpm, matchRate, requests, date);
...
abstract mixin class $AdMobMetricsCopyWith<$Res> {
  factory $AdMobMetricsCopyWith(
          AdMobMetrics value, $Res Function(AdMobMetrics) _then) =
      _$AdMobMetricsCopyWithImpl;
  @useResult
  $Res call(
      {double earnings,
      int impressions,
...
/// @nodoc
class _$AdMobMetricsCopyWithImpl<$Res> implements $AdMobMetricsCopyWith<$Res> {
...
extension AdMobMetricsPatterns on AdMobMetrics {
  ...
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_AdMobMetrics value)? $default, {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(double earnings, int impressions, double ecpm,
            double matchRate, int requests, DateTime date)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _AdMobMetrics() when $default != null:
        return $default(_that.earnings, _that.impressions, _that.ecpm,
            _that.matchRate, _that.requests, _that.date);
      case _:
        return orElse();
    }
  }
...
class _AdMobMetrics implements AdMobMetrics {
  const _AdMobMetrics(
      ...
      required this.date});
  factory _AdMobMetrics.fromJson(Map<String, dynamic> json) =>
      _$AdMobMetricsFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$AdMobMetricsCopyWith<_AdMobMetrics> get copyWith =>
      __$AdMobMetricsCopyWithImpl<_AdMobMetrics>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$AdMobMetricsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$AdMobMetricsCopyWith<$Res>
    implements $AdMobMetricsCopyWith<$Res> {
  factory _$AdMobMetricsCopyWith(
          _AdMobMetrics value, $Res Function(_AdMobMetrics) _then) =
      __$AdMobMetricsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {double earnings,
...
mixin _$PlayConsoleMetrics {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $PlayConsoleMetricsCopyWith<PlayConsoleMetrics> get copyWith =>
      _$PlayConsoleMetricsCopyWithImpl<PlayConsoleMetrics>(
          this as PlayConsoleMetrics, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is PlayConsoleMetrics &&
            (identical(other.revenue, revenue) || other.revenue == revenue) &&
            (identical(other.installs, installs) ||
                other.installs == installs) &&
            (identical(other.activeDevices, activeDevices) ||
                other.activeDevices == activeDevices) &&
            (identical(other.averageRating, averageRating) ||
                other.averageRating == averageRating) &&
            (identical(other.crashRate, crashRate) ||
                other.crashRate == crashRate) &&
            (identical(other.anrRate, anrRate) || other.anrRate == anrRate) &&
            (identical(other.date, date) || other.date == date));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, revenue, installs, activeDevices,
      averageRating, crashRate, anrRate, date);
...
abstract mixin class $PlayConsoleMetricsCopyWith<$Res> {
  factory $PlayConsoleMetricsCopyWith(
          PlayConsoleMetrics value, $Res Function(PlayConsoleMetrics) _then) =
      _$PlayConsoleMetricsCopyWithImpl;
  @useResult
  $Res call(
      {double revenue,
      int installs,
...
class _$PlayConsoleMetricsCopyWithImpl<$Res>
  ...
  $Res call({
    Object? revenue = null,
    Object? installs = null,
    Object? activeDevices = null,
    Object? averageRating = null,
    Object? crashRate = null,
    Object? anrRate = null,
    Object? date = null,
  }) {
    return _then(_self.copyWith(
      revenue: null == revenue
          ...
          : revenue // ignore: cast_nullable_to_non_nullable
              as double,
      installs: null == installs
          ? _self.installs
          : installs // ignore: cast_nullable_to_non_nullable
              as int,
      ...
      averageRating: null == averageRating
          ...
          : averageRating // ignore: cast_nullable_to_non_nullable
              as double,
      crashRate: null == crashRate
          ? _self.crashRate
          : crashRate // ignore: cast_nullable_to_non_nullable
              as double,
      anrRate: null == anrRate
          ? _self.anrRate
          : anrRate // ignore: cast_nullable_to_non_nullable
              as double,
      date: null == date
          ? _self.date
          : date // ignore: cast_nullable_to_non_nullable
...
extension PlayConsoleMetricsPatterns on PlayConsoleMetrics {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_PlayConsoleMetrics value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  TResult maybeWhen<TResult extends Object?>(
    ...
    switch (_that) {
      case _PlayConsoleMetrics() when $default != null:
        return $default(_that.revenue, _that.installs, _that.activeDevices,
            _that.averageRating, _that.crashRate, _that.anrRate, _that.date);
      case _:
        return orElse();
    }
  }
...
class _PlayConsoleMetrics implements PlayConsoleMetrics {
  const _PlayConsoleMetrics(
      ...
      required this.date});
  factory _PlayConsoleMetrics.fromJson(Map<String, dynamic> json) =>
      _$PlayConsoleMetricsFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$PlayConsoleMetricsCopyWith<_PlayConsoleMetrics> get copyWith =>
      __$PlayConsoleMetricsCopyWithImpl<_PlayConsoleMetrics>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$PlayConsoleMetricsToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$PlayConsoleMetricsCopyWith<$Res>
    implements $PlayConsoleMetricsCopyWith<$Res> {
  factory _$PlayConsoleMetricsCopyWith(
          _PlayConsoleMetrics value, $Res Function(_PlayConsoleMetrics) _then) =
      __$PlayConsoleMetricsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {double revenue,
...
mixin _$CombinedAnalytics {
  AdMobMetrics? get admob;
  PlayConsoleMetrics? get play;
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CombinedAnalyticsCopyWith<CombinedAnalytics> get copyWith =>
      _$CombinedAnalyticsCopyWithImpl<CombinedAnalytics>(
          this as CombinedAnalytics, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CombinedAnalytics &&
...
abstract mixin class $CombinedAnalyticsCopyWith<$Res> {
  factory $CombinedAnalyticsCopyWith(
          CombinedAnalytics value, $Res Function(CombinedAnalytics) _then) =
      _$CombinedAnalyticsCopyWithImpl;
  @useResult
  $Res call(
...
extension CombinedAnalyticsPatterns on CombinedAnalytics {
  ...
  @optionalTypeArgs
  TResult maybeMap<TResult extends Object?>(
    TResult Function(_CombinedAnalytics value)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
  ...
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(AdMobMetrics? admob, PlayConsoleMetrics? play,
    ...
    switch (_that) {
      case _CombinedAnalytics() when $default != null:
        return $default(_that.admob, _that.play, _that.lastRefreshed);
      case _:
        return orElse();
    }
  }
...
class _CombinedAnalytics implements CombinedAnalytics {
  const _CombinedAnalytics(
      {this.admob, this.play, required this.lastRefreshed});

  @override
  final AdMobMetrics? admob;
  @override
  final PlayConsoleMetrics? play;
  @override
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CombinedAnalyticsCopyWith<_CombinedAnalytics> get copyWith =>
      __$CombinedAnalyticsCopyWithImpl<_CombinedAnalytics>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CombinedAnalytics &&
            (identical(other.admob, admob) || other.admob == admob) &&
            (identical(other.play, play) || other.play == play) &&
            (identical(other.lastRefreshed, lastRefreshed) ||
                other.lastRefreshed == lastRefreshed));
...
/// @nodoc
abstract mixin class _$CombinedAnalyticsCopyWith<$Res>
    implements $CombinedAnalyticsCopyWith<$Res> {
  factory _$CombinedAnalyticsCopyWith(
          _CombinedAnalytics value, $Res Function(_CombinedAnalytics) _then) =
      __$CombinedAnalyticsCopyWithImpl;
  @override
  @useResult
  $Res call(
      {AdMobMetrics? admob, PlayConsoleMetrics? play, DateTime lastRefreshed});
